...
export const BASE_INFUSION_TIME: Record<TStrength, Record<TConcentration, number[]>> = {
  weakest: {
    ...
    '1/20': [5, 10, 10, 15, 20, 30, 45, 60, 120, 180, 300, 480, 960],
  ...
  weak: {
    ...
    '1/20': [10, 10, 15, 20, 30, 45, 60, 120, 180, 300, 480, 960],
  ...
  normal: {
    ...
    '1/20': [10, 15, 20, 30, 45, 60, 120, 180, 300, 480, 960],
  ...
  strong: {
    ...
    '1/15': [20, 30, 45, 60, 180, 300, 960],
    '1/20': [30, 45, 60, 180, 300, 960],
    '1/30': [120, 180, 300, 960],
    '1/50': [300, 480, 960],
    '1/100': [480, 960],
  },
  strongest: {
    '1/10': [20, 30, 45, 60, 120, 180, 300, 480, 960],
    '1/15': [30, 60, 180, 300, 960],
    '1/20': [60, 180, 300, 960],
